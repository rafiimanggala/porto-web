...
export default function CommandPalette() {
  ...
  const actions = useMemo<Action[]>(
    () => [
      ...
      { label: "Agent OS", hint: "03", group: "Navigate", run: () => goto("#agent-os") },
      { label: "Custom toolkit", hint: "04", group: "Navigate", run: () => goto("#toolkit") },
      { label: "Native, AI-driven", hint: "05", group: "Navigate", run: () => goto("#native") },
      { label: "Project index", hint: "06", group: "Navigate", run: () => goto("#index") },
      { label: "About", hint: "07", group: "Navigate", run: () => goto("#contact") },
